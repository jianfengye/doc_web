...
在Go的语言演进过程中，error传递的信息太少一直是被诟病的一点。这个情况在GO1.13之后有了些许改变，下面我们用例子来介绍一下我们今天要推荐的库。
...
从这个包里面，我们就可以看到go的鸭子类型接口的优势了。只需要我们在函数调用的时候使用的是接口。比如这里的github.com/pkg/errors包中的三种错误类型
